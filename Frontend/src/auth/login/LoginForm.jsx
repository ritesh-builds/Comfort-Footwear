...
function LoginForm({ onSwitch }) {
  ...
  return (
    ...
    >
      ...
      <div className="glass-orb w-[450px] h-[450px] -bottom-20 -left-20 opacity-25 dark:opacity-15 bg-gradient-to-tr from-cyan-200/30 via-blue-200/25 to-purple-200/25 blur-[120px]" />
          ...
          >
            ...
            <div className="mt-3.5">
              <button
                ...
                className={`w-full py-3.5 rounded-full cursor-pointer text-xs font-medium transition-all duration-300 flex items-center justify-center gap-2.5 ${
                  darkMode
                    ? "glass-btn-dark"
                    : "glass-btn-light"
                }`}
